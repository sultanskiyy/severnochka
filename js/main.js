...
function showProducts(content, data){
    ...
    <div class="bg-gray-50 p-3 sm:p-4 hover:shadow-[0_0_20px_4px_rgba(255,165,0,0.7)]  duration-1000 rounded-[6px] flex flex-col">
      ...
      <div class="flex justify-between py-1 sm:py-2">
        <p class="text-lg sm:text-[22px] font-bold">${el.price} ₽</p>
        <p class="text-lg sm:text-[22px]">${el.price -el.price * el.discount /100} ₽</p>
      </div>
      <div class="flex justify-between text-sm sm:text-[14px]">
        <p class="text-gray-500">Обычная</p>
        <p>Скидка</p>
      </div>
      <div class="py-2 sm:py-3 flex flex-col items-center">
        <p class="line-clamp-2 text-base sm:text-[18px] pb-2 sm:pb-2">${el.description}</p>
        ${
            el.rating === 5 ? `
        ...
        <div class="flex gap-[5px]">
          <img src="./assets/yulduzlar/yulduz.svg" alt="">
          <img src="./assets/yulduzlar/bosh-yulduz.svg" alt="">
          <img src="./assets/yulduzlar/boshyulduz.svg" alt="">
          <img src="./assets/yulduzlar/bosh-yulduz.svg" alt="">
          <img src="./assets/yulduzlar/bosh-yulduz.svg" alt="">
        </div>
        ` : el.rating === 0.5 ? `
